		...
		<ng-container>
			...
			<ul #submenu *ngIf="item.items && item.visible !== false" [@children]="submenuAnimation" (@children.done)="onSubmenuAnimated($event)">
				<ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
					<li organizer-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"></li>
				</ng-template>
			</ul>
		</ng-container>
    `,
...
export class OrganizerMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public layoutService: OrganizerLayoutService, private cd: ChangeDetectorRef,private appSidebar: OrganizerSidebarComponent, public router: Router, private menuService: OrganizerMenuService) {
