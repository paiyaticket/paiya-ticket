...
import {
    ColorScheme,
    OrganizerLayoutService,
    MenuMode,
} from '../service/organizer.layout.service';
...
@Component({
    selector: 'organizer-config',
    templateUrl: './organizer.config.component.html',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
...
export class OrganizerConfigComponent implements OnInit {
    ...
    constructor(
        ...
        public menuService: OrganizerMenuService
    ) {}
