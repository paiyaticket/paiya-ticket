...
import {
    ColorScheme,
    ParticipantLayoutService,
    MenuMode,
} from '../service/participant.layout.service';
...
@Component({
    selector: 'participant-config',
    templateUrl: './participant.config.component.html',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
...
export class ParticipantConfigComponent implements OnInit {
    ...
    constructor(
        ...
        public menuService: ParticipantMenuService
    ) {}
